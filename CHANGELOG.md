...
[GitHub PR](https://github.com/i-mwangi/Alpha-Mind/pulls)
...
Updated functionality to load PERPLEXITY_API_KEY from .env and hide local storage management of API key if provided.
